...
function t_form_phonemask_load(t) {
    var a = t.attr("data-phonemask-id"), p = t.attr("data-phonemask-lid"),
        n = t.attr("data-phonemask-maskcountry") || "";
    "undefined" != n && n && 0 != n.length || (n = ""), t.attr("data-phonemask-init", "yes"), setTimeout(function () {
        try {
...
function t_form_phonemask_init(a, p, t) {
    void 0 !== t && "" != t ? t_form_phonemask_do(a, p, t) : void 0 !== window.geo_iso && "" != window.geo_iso && null != window.geo_iso ? t_form_phonemask_do(a, p, window.geo_iso) : $.ajax({
        type: "GET",
        url: "https://geo.tildacdn.com/geo/country/",
        success: function (t) {
            window.geo_iso = t, t_form_phonemask_do(a, p, t)
        },
        error: function () {
...
function t_form_phonemask_do(t, a, p) {
    var n = $("#rec" + t).find('[data-input-lid="' + a + '"]');
    ...
    void 0 !== e[p] ? i = e[p] : (i = {
        ...
        c: "+7",
        m: "+7(999) 999-99-99"
    }, p = "ru"), o.attr("data-phonemask-code", 0 < p.length ? i.c : ""), o.attr("data-phonemask-mask", 0 < p.length ? i.m : ""), t_form_phonemask_calc_maxlength(o), 0 < p.length && (localStorage.setItem("iso_code", p), n.find(".t-input-phonemask__select-flag").attr("data-phonemask-flag", p), n.find(".t-input-phonemask__select-code").html(i.c), void 0 !== o.attr("data-phonemask-mask") && o.attr("placeholder", o.attr("data-phonemask-mask").substr(o.attr("data-phonemask-code").length).replace(/^-+/, "")), t_form_phonemask_change_min_length(o.attr("placeholder"), o.attr("data-phonemask-code"), n)), t_form_phonemask_add_current_style(n), n.find(".t-input-phonemask__options-wrap").html(t_form_phonemask_draw_selector(e)), n.find(".t-input-phonemask__select").on("click", function () {
        $(".t-input-phonemask__options-wrap").removeClass("t-input-phonemask__options-wrap_open"), $(this).siblings(".t-input-phonemask__options-wrap").toggleClass("t-input-phonemask__options-wrap_open")
    }), n.find(".t-input-phonemask__options-item").on("click", function () {
        t_form_phonemask_choose_country(n, a, $(this)), t_form_phonemask_calc_maxlength(o)
    }), o.on("input", function () {
        var t = $(this);
        "(" == t.val() && (t.val(""), n.find(".js-phonemask-result").val("")), t.attr("data-phonemask-current", t.val()), t_form_phonemask_add_number_mask(t_form_phonemask_copypaste_handling(t, o.attr("data-phonemask-without-code")), $(this)), t_form_phonemask_change_val(o, n)
    ...
    $(document).on("keyup", function (p) {
        $(".t-input-phonemask__options-wrap").each(function () {
            if ($(this).hasClass("t-input-phonemask__options-wrap_open")) {
                var t = [];
                if ($(".t-input-phonemask__options-item").removeClass("t-input-phonemask__options-item_chosen"), 48 <= p.keyCode && p.keyCode <= 57 || 96 <= p.keyCode && p.keyCode <= 105) for (var a in s += p.key, e) t_form_phonemask_search_country($(this), s, t_form_phonemask_regexp_replace(s), t, e, a, e[a].c); else if (65 <= p.keyCode && p.keyCode <= 90 || 32 == p.keyCode) for (var a in s += p.key, e) t_form_phonemask_search_country($(this), s, "^" + t_form_phonemask_regexp_replace(s), t, e, a, e[a].n);
...
function t_form_phonemask_calc_maxlength(t) {
    ...
    "-" == a.charAt(0) && (a = a.substring(1)), t.attr("maxlength", a.length), t.attr("data-phonemask-without-code", a)
}

function t_form_phonemask_copypaste_handling(t, a) {
    var p = t.val(), n = null != p.match(/[0-9]/g) ? p.match(/[0-9]/g) : p;
...
function t_form_phonemask_search_country(t, a, p, n, o, i, e) {
    var s, h = new RegExp(p, "i");
    -1 != e.search(h) && (n.push(t.find("#" + o[i].id)), n[0].addClass("t-input-phonemask__options-item_chosen"), (s = t).animate({scrollTop: t.find(".t-input-phonemask__options-item_chosen").offset().top - s.offset().top + s.scrollTop()}, 0))
}

function t_form_phonemask_replace_input(t) {
    var a = t.find(".js-phonemask-input"), p = a.attr("name"), n = "";
...
function t_form_phonemask_draw_selector(t) {
    var a = "";
    for (var p in t) a += '<div class="t-input-phonemask__options-item" id="' + t[p].id + '" data-phonemask-name="' + t[p].n + '" data-phonemask-mask="' + t[p].m + '" data-phonemask-country-code="' + p + '" data-phonemask-code="' + t[p].c + '">', a += '<div class="t-input-phonemask__options-name">' + t[p].n + "</div>", a += '<span class="t-input-phonemask__options-code">' + t[p].c + "</span>", a += '<span class="t-input-phonemask__options-flag t-input-phonemask__options-flag_' + p + '"></span>', a += "</div>";
    return a
}

function t_form_phonemask_add_number_mask(t, a) {
    var p = a.attr("data-phonemask-code"), n = a.attr("data-phonemask-mask").substr(p.length), o = t.match(/\d+/g),
        i = (o = o ? o.join("") : "").split(""), e = n.match(/(\+|\d+|[\s()-]|9+)/g), s = "";
    if (null != e) {
...
function t_form_phonemask_choose_country(t, a, p) {
    var n = t.find(".t-input-phonemask"), o = t.find(".t-input-phonemask__select"), i = p.attr("data-phonemask-code"),
...
function t_form_phonemask_add_current_style(t) {
    ...
    a.parents(".t-input-block").css("overflow", "initial"), setTimeout(function () {
        a.parents(".t-input-block").css("overflow", "initial")
    }, 2e3), t.find(".t-input-phonemask").css("color", a.css("color")), t.find(".t-input-phonemask").css("font-size", a.css("font-size")), t.find(".t-input-phonemask__select-code").css("font-size", a.css("font-size")), t.find(".t-input-phonemask").css("font-weight", a.css("font-weight"))
}
...
function t_form_phonemask_getCountriesList() {
    return {
        ...
        au: {n: "Australia", c: "+61", m: "+61-9-9999-9999", id: "t-phonemask_au"},
        at: {n: "Austria (Österreich)", c: "+43", m: "+43(999) 999-9999", id: "t-phonemask_at"},
        ...
        br: {n: "Brazil (Brasil)", c: "+55", m: "+55(99) 9999-9999", id: "t-phonemask_br"},
        bm: {n: "Brazil (Brasil) (mobile)", c: "+55", m: "+55(99) 99999-9999", id: "t-phonemask_bm"},
        ...
        hr: {n: "Croatia (Hrvatska)", c: "+385", m: "+385-99-999-999", id: "t-phonemask_hr"},
        ...
        fi: {n: "Finland (Suomi)", c: "+358", m: "+358(999) 999-99-99", id: "t-phonemask_fi"},
        fr: {n: "France", c: "+33", m: "+33(999) 999-999", id: "t-phonemask_fr"},
        ...
        il: {n: "Israel (ישראל‎)", c: "+972", m: "+972-9-999-99999", id: "t-phonemask_il"},
        ...
        ng: {n: "Nigeria", c: "+234", m: "+234-99-999-999", id: "t-phonemask_ng"},
        ...
        tr: {n: "Turkey (Türkiye)", c: "+90", m: "+90(999) 999-9999", id: "t-phonemask_tr"},
        ...
        gb: {n: "United Kingdom", c: "+44", m: "+44-99-9999-9999", id: "t-phonemask_gb"},
...
$(document).ready(function () {
    $(".js-phonemask-input").each(function () {
        t_form_phonemask_load($(this))
    })
});